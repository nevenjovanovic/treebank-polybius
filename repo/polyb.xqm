...
<div class="container">
<h3> </h3>
<h1 class="text-center"><a href="https://github.com/nevenjovanovic/treebank-polybius" class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i> <span class="network-name">Github</span></a></h1>
<div class="row">
<div  class="col-md-3">
</div> 
<div  class="col-md-6">
